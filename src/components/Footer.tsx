...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className={`relative border-t border-white/5 bg-[#080812] overflow-hidden transition-all duration-700 ${vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#e8a838] to-[#d4952a] flex items-center justify-center shadow-lg shadow-[#e8a838]/20">
                <Film className="w-[18px] h-[18px] text-[#0d0d1a]" />
              </div>
